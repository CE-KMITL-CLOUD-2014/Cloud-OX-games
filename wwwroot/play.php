    ...
    if (!isset($_SESSION['userid'])){
		...
		//	echo "<table><tr><td>Room's name</td><td>Creator</td><td>Player</td></tr>";
			while($row = $result->fetch_assoc()) {
				echo "<ol class='round'><li><h5>Room's name : ". $row["name"] ."</h5> <a href='table.php?table_req=". $row["id"] ."&playable=1'>join</a><br><a href='table.php?table_req=". $row["id"] ."&playable=0'>view</a>";
